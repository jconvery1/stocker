...
<div>
    <div class="flex justify-between m-2 p-2">
        <span class="self-center text-xl font-semibold whitespace-nowrap">Category Collection</span>
        <div class="flex justify-end">
            <span class="self-center text-l whitespace-nowrap mr-5">Add a new category here!</span>
            <div>
                <input
    ...
    <div class="relative overflow-x-auto">
        <div v-if="this.categories !== null">
            ...
            <div class="flex flex-col items-center mt-2">
                <span v-if="categories.length == 0" class="text-sm text-gray-700 dark:text-gray-400">
                    No entries found
                </span>
            </div>
        </div>
