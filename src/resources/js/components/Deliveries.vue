        ...
        <div v-if="this.deliveries !== null">
            <div class="p-2 bg-white">
                ...
                <div class="relative mt-1">
                    ...
                    <input v-model="search" type="text" id="table-search" class="block p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Search by delivery number">
                </div>
            </div>
            <table class="w-full text-sm text-left text-gray-500">
                ...
                <tbody>
                    <tr v-for="delivery in filteredResults" :key="delivery.id" class="bg-white border-b hover:bg-gray-50">
            ...
            <div class="flex flex-col items-center mt-2">
                <!-- Help text -->
                <span v-if="deliveries.from" class="text-sm text-gray-700 dark:text-gray-400">
                ...
                <div class="inline-flex mt-2 xs:mt-0">
                    <button v-if="deliveries.current_page > 1" @click="getDeliveries(deliveries.current_page - 1)" class="px-4 py-2 text-sm font-medium text-white bg-gray-800 rounded hover:bg-gray-900 m-1">
                        Prev
                    </button>
                    <button v-if="deliveries.current_page < deliveries.last_page" @click="getDeliveries(deliveries.current_page + 1)" class="px-4 py-2 text-sm font-medium text-white bg-gray-800 border-0 border-l border-gray-700 rounded hover:bg-gray-900 m-1">
                        Next
                    </button>
                </div>
            </div>
