        ...
        <div v-if="(this.stockItems && this.settings) !== null">
            <div class="p-2 bg-white">
                ...
                <div class="relative mt-1">
                    ...
                    <input v-model="search" type="text" id="table-search" class="block p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Search for items">
                </div>
            </div>
            <table
                id="tableId"
...
export default {
    ...
    computed: {
        filteredResults() {
            ...
            return this.stockItems.data.filter((item) => item.name.includes(this.search));
        }
    },
    methods: {
